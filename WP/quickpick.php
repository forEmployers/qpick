...
function getDependencies()
{
    ...
    wp_enqueue_style('MAXKING-STYLE', $basepath . '/static/css/2.8dbe6964.chunk.css');

    # scripts - First param must be unique
    wp_enqueue_script('MAXKING-CHUNK',  $basepath . '/static/js/2.e32d2b97.chunk.js');
    wp_enqueue_script('MAXKING-MAINS',  $basepath . '/static/js/main.8d7cbfaa.chunk.js');
}